...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TapToPlaceObject_Start_m8FB533F18AA38AD2CAC674C4F7337785E7ED2B4B (TapToPlaceObject_tCB424A32FF3FB71697D7C889890B61CA6F28582D * __this, const RuntimeMethod* method)
{
	...
	{
		__this->set_placementPoseIsValid_7((bool)0);
...
{
	{
		bool L_0 = __this->get_placementPoseIsValid_7();
		if (!L_0)
		{
			goto IL_003b;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TapToPlaceObject_UpdatePlacementPose_mE04DC82C11D0486C121F88292A63FDCFEB805D98 (TapToPlaceObject_tCB424A32FF3FB71697D7C889890B61CA6F28582D * __this, const RuntimeMethod* method)
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		V_1 = L_3;
		ARSessionOrigin_t61463C0A24AF925CF219B6C3F1720325C96720EF * L_4 = __this->get_arOrigin_5();
		NullCheck(L_4);
		ARRaycastManager_t81A9513150BA5BE536DF064F1C6DE73349A60BE7 * L_5 = Component_GetComponent_TisARRaycastManager_t81A9513150BA5BE536DF064F1C6DE73349A60BE7_m71DCE7466C02DBA59A1618314D7FA98D931BD522(L_4, /*hidden argument*/Component_GetComponent_TisARRaycastManager_t81A9513150BA5BE536DF064F1C6DE73349A60BE7_m71DCE7466C02DBA59A1618314D7FA98D931BD522_RuntimeMethod_var);
		...
		__this->set_placementPoseIsValid_7((bool)((((int32_t)L_10) > ((int32_t)0))? 1 : 0));
		bool L_11 = __this->get_placementPoseIsValid_7();
		if (!L_11)
		{
			goto IL_0066;
		}
	}
	{
		...
		V_2 = L_13;
		Pose_t2997DE3CB3863E4D78FCF42B46FC481818823F29  L_14 = ARRaycastHit_get_pose_m5CCFFED6C4A101EA42083A8661956A2B4B4C4A0D((ARRaycastHit_t509D3DB25CAC944ED3D3092C0A6096F85DDDD1BC *)(&V_2), /*hidden argument*/NULL);
		__this->set_placementPose_6(L_14);
	}
