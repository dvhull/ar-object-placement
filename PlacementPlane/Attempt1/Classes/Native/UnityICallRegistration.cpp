void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.Experimental.XR.XRMeshSubsystem
		...
		void Register_UnityEngine_Experimental_XR_XRMeshSubsystem_GetMeshInfosAsList();
		Register_UnityEngine_Experimental_XR_XRMeshSubsystem_GetMeshInfosAsList();

		//System.Boolean UnityEngine.Experimental.XR.XRMeshSubsystem::SetBoundingVolume_Injected(UnityEngine.Vector3&,UnityEngine.Vector3&)
		void Register_UnityEngine_Experimental_XR_XRMeshSubsystem_SetBoundingVolume_Injected();
		Register_UnityEngine_Experimental_XR_XRMeshSubsystem_SetBoundingVolume_Injected();
		...
		void Register_UnityEngine_Experimental_XR_XRMeshSubsystem_GenerateMeshAsync_Injected();
		Register_UnityEngine_Experimental_XR_XRMeshSubsystem_GenerateMeshAsync_Injected();

		//System.Void UnityEngine.Experimental.XR.XRMeshSubsystem::set_meshDensity(System.Single)
		void Register_UnityEngine_Experimental_XR_XRMeshSubsystem_set_meshDensity();
		Register_UnityEngine_Experimental_XR_XRMeshSubsystem_set_meshDensity();

	//End Registrations for type : UnityEngine.Experimental.XR.XRMeshSubsystem
